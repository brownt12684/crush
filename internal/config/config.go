...
type Config struct {
	...
	Hooks map[string][]HookConfig `json:"hooks,omitempty" jsonschema:"description=User-defined shell commands that fire on hook events (e.g. PreToolUse, PostToolUse, PreTurn, PostTurn)"`
