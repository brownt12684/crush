	...
	return WithAliases(
		fantasy.NewParallelAgentTool(
			...
			func(ctx context.Context, params ReadMCPResourceParams, call fantasy.ToolCall) (fantasy.ToolResponse, error) {
				...
				if strings.HasPrefix(strings.ToLower(params.URI), "crush://skills/") {
					return fantasy.NewTextErrorResponse(
						"Do not use read_mcp_resource to load Crush skills. Use the view tool with the crush://skills/... identifier instead.",
					), nil
				}
